 ...
 * @author Axel Reyes
 */
public class frmRsolicitud_rechazadas extends javax.swing.JFrame {

    /**
     * Creates new form frmProductoDañado
     */
    public frmRsolicitud_rechazadas() {
        initComponents();
        cargarComboBox();
        cargarReporte();
    ...
    private void initComponents() {
        ...
        lbTitulo.setText("Reporte de Solicitudes Rechazadas");
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        try {
            ...
            // 3. Definir las columnas de la tabla
            String[] columnNames = { "ID","Proveedor","Productos", "Motivo", "Total rechazados"};
            int[] columnWidths = {40, 120, 100, 130, 140,80}; // Ajustar anchos de columnas
            ...
            DRDataSource dataSource = new DRDataSource(
                "ID","Proveedor",  "Productos", "Motivo", "Total rechazados"
            );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRsolicitud_rechazadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmRsolicitud_rechazadas().setVisible(true);
            }
        });
    }
private void cargarReporte() {
    ...
    try {
        ...
        String sql = "{CALL sp_reporte_solicitudes_rechazadas(?, ?)}"; // Usar CALL para ejecutar procedimientos almacenados
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                String productos = rs.getString("productos_rechazados");
                String motivo = rs.getString("motivo_rechazo");
                int total_rechazo = rs.getInt("total_productos_rechazados");

                // Agregar los datos a la tabla
                model.addRow(new Object[]{ idSolicitud, proveedor, productos, motivo, total_rechazo });
            }
...
private void cargarComboBox() {
    ...
    // Cargar años
    String sqlAnios = "SELECT DISTINCT(YEAR(fecha_rechazo)) Anios FROM solicitudes ORDER BY Anios ASC";
    try (Connection conn = DatabaseConnection.getConnection();
         Statement stmt = conn.createStatement();
         ResultSet rs = stmt.executeQuery(sqlAnios)) {

        while (rs.next()) {
            cmbAno.addItem(String.valueOf(rs.getInt("Anios")));
        }
    } catch (SQLException e) {
        e.printStackTrace();
